...
- 当前开发阶段是 **P4：硬装与材质管线（IN_PROGRESS）**。
- P2、P3 已完成；P5 及以后能力即使已有演示代码，也只能视为冻结的预研原型。
...
| **P4 硬装与材质管线** | **`IN_PROGRESS`** | PBR 材质、硬装构件、灯光与跨导出一致性正在实现 |
| P5-P10 | `BLOCKED` | 精装资产、生产 Viewer、Blender、修订、输入扩展和生产化 |
