...
- 当前开发阶段是 **P5：精装设计与真实资产（IN_PROGRESS）**。
- P2-P4 已完成；P6 及以后能力即使已有演示代码，也只能视为冻结的预研原型。
...
| **P5 精装设计与资产** | **`IN_PROGRESS`** | 结构化设计、布局和资产闭环正在实现 |
| P6-P10 | `BLOCKED` | 生产 Viewer、Blender、修订、输入扩展和生产化 |
