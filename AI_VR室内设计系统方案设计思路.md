...
- 当前开发阶段是 **P6：生产级 Viewer 与 WebXR（IN_PROGRESS）**。
- P2-P5 已完成；P7 及以后能力即使已有演示代码，也只能视为冻结的预研原型。
...
| **P6 Viewer 与 WebXR** | **`IN_PROGRESS`** | 生产交互、导航、生命周期和设备契约正在实现 |
| P7-P10 | `BLOCKED` | Blender、修订、输入扩展和生产化 |
